...
@WebServlet(name = "ShopFloorUI", urlPatterns = { "/DeviceMap" })
public class ShopFloorUI extends HttpServlet {
	    ...
	    public void doTask(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	        ...
	        if(requestType.equalsIgnoreCase("initial")){   
	            request.getRequestDispatcher("shopfloorui.jsp").forward(request, response);
	        }
	    }
