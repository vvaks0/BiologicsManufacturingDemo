...
if ! [[ "$NIFISTATUS" == INSTALLED || "$NIFISTATUS" == STARTED ]]; then
	...
	/var/lib/ambari-server/resources/scripts/configs.sh set sandbox.hortonworks.com Sandbox nifi-ambari-config /root/BiologicsManufacturingDemo/Nifi/config/nifi-ambari-config.json
	sleep 2
	/var/lib/ambari-server/resources/scripts/configs.sh set sandbox.hortonworks.com Sandbox nifi-bootstrap-env /root/BiologicsManufacturingDemo/Nifi/config/nifi-bootstrap-env.json
	sleep 2
	/var/lib/ambari-server/resources/scripts/configs.sh set sandbox.hortonworks.com Sandbox nifi-flow-env /root/BiologicsManufacturingDemo/Nifi/config/nifi-flow-env.json
	sleep 2
	/var/lib/ambari-server/resources/scripts/configs.sh set sandbox.hortonworks.com Sandbox nifi-logback-env /root/BiologicsManufacturingDemo/Nifi/config/nifi-logback-env.json
	sleep 2
	/var/lib/ambari-server/resources/scripts/configs.sh set sandbox.hortonworks.com Sandbox nifi-properties-env /root/BiologicsManufacturingDemo/Nifi/config/nifi-properties-env.json
...
#Configure Kafka
/usr/hdp/current/kafka-broker/bin/kafka-topics.sh --create --zookeeper sandbox.hortonworks.com:2181 --replication-factor 1 --partitions 1 --topic IncomingBioReactorEvents
/usr/hdp/current/kafka-broker/bin/kafka-topics.sh --create --zookeeper sandbox.hortonworks.com:2181 --replication-factor 1 --partitions 1 --topic IncomingFiltrationEvents
...
service docker start
docker pull vvaks/biologicsmanufacturingui
